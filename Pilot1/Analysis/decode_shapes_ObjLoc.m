...
savepath = fullfile(root, 'Analysis','Decoding_results','PairwiseAcc_ObjLoc.mat');
...
for ss=1:nSubj
    ...
    fn2load = fullfile(root, 'Samples', sprintf('NeutralTaskSignalByTrial_ObjLoc_S%s.mat', sublist{ss}));
    load(fn2load);
