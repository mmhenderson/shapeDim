...
for ss=1:length(sublist)
    ...
    load([root, 'SampleFile_Retinotopic_S', my_subject,'.mat'],'samplesMain','main','ROIs','all_vox_concat');

    fn2save = [root 'NeutralTaskSignalByTrial_Retinotopic_S' my_subject, '.mat'];
   
    %% vis areas to use

    my_areas = {'V1','V2','V3','V3AB','V4','IPS0','IPS1','IPS2','IPS3','LO1','LO2'};
